...
const Technologies = () => {
  return (
    <section id = "technologies" className="border-b-[2px] border-slate-700 pb-24 lg:mx-10">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <div className="relative rounded-2xl border-4 border-slate-700 p-4 group h-30 w-30">
          <div className="absolute inset-0 bg-gradient-to-r from-sky-600 via-sky-400 to-sky-600 rounded-xl -z-10 before:ease before:absolute before:-left-2 before:mt-[3.75rem] before:-ml-2 before:h-48 before:w-48 before:origin-top-right before:-translate-x-full before:translate-y-12 before:-rotate-90 before:bg-gray-900 before:transition-all before:duration-300 group-hover:before:-rotate-180 group-hover:shadow-2xl group-hover:shadow-sky-500 overflow-hidden transition-shadow duration-500 ease-in-out"></div>
        ...
        <div className="relative rounded-2xl border-4 border-slate-700 p-4 group h-30 w-30">
          <div className="absolute inset-0 bg-gradient-to-r from-green-600 via-green-400 to-green-600 rounded-xl -z-10 before:ease before:absolute before:-left-2 before:mt-[3.75rem] before:-ml-2 before:h-48 before:w-48 before:origin-top-right before:-translate-x-full before:translate-y-12 before:-rotate-90 before:bg-gray-900 before:transition-all before:duration-300 group-hover:before:-rotate-180 group-hover:shadow-2xl group-hover:shadow-green-500 overflow-hidden transition-shadow duration-500 ease-in-out"></div>
          <BiLogoDjango className="text-7xl text-[#092e20] transition-all duration-300 group-hover:opacity-10 group-hover:text-green-400" />
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        ...
        <div className="relative rounded-2xl border-4 border-slate-700 p-4 group h-30 w-30">
          <div className="absolute inset-0 bg-gradient-to-r from-red-600 via-red-400 to-red-600 rounded-xl -z-10 before:ease before:absolute before:-left-2 before:mt-[3.75rem] before:-ml-2 before:h-48 before:w-48 before:origin-top-right before:-translate-x-full before:translate-y-12 before:-rotate-90 before:bg-gray-900 before:transition-all before:duration-300 group-hover:before:-rotate-180 group-hover:shadow-2xl group-hover:shadow-red-500 overflow-hidden transition-shadow duration-500 ease-in-out"></div>
        ...
        <div className="relative rounded-2xl border-4 border-slate-700 p-4 group h-30 w-30">
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-600 via-yellow-400 to-yellow-600 rounded-xl -z-10 before:ease before:absolute before:-left-2 before:mt-[3.75rem] before:-ml-2 before:h-48 before:w-48 before:origin-top-right before:-translate-x-full before:translate-y-12 before:-rotate-90 before:bg-gray-900 before:transition-all before:duration-300 group-hover:before:-rotate-180 group-hover:shadow-2xl group-hover:shadow-yellow-500 overflow-hidden transition-shadow duration-500 ease-in-out"></div>
          <SiOpenai className="text-7xl text-emerald-600 transition-opacity duration-300 group-hover:opacity-10" />
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
